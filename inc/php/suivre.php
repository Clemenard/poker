...
//update de joueur
$joueur['jetons']-=$miseMax['miseMax']-$donne['mise'];
...
$donne['mise']=$miseMax['miseMax'];
    ...
    execRequete('UPDATE   joueur SET jetons =:jetons WHERE id_utilisateur = :id_u ',
    array(':id_u'=>$_SESSION['membre']['id_utilisateur'],':jetons'=>$joueur['jetons']));
